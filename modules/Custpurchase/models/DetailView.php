...
class Custpurchase_DetailView_Model extends Inventory_DetailView_Model {
	...
	/*$projectModuleModel = Vtiger_Module_Model::getInstance('Project');
		if($currentUserModel->hasModuleActionPermission($projectModuleModel->getId(), 'EditView')) {
			$basicActionLink = array(
				'linktype' => 'DETAILVIEW',
				'linklabel' => vtranslate('LBL_GENERATE').' '.vtranslate($projectModuleModel->getSingularLabelKey(), 'Project'),
