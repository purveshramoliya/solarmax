...
class Quotes_Record_Model extends Inventory_Record_Model {
   ...
   /* public function getCreateProjectUrl() {
		...
		return "index.php?module=".$projectModuleModel->getName()."&view=".$projectModuleModel->getEditViewName()."&quote_id=".$this->getId();
	}*/
	
	public function getCreateSalesOrderUrl() {
		$salesOrderModuleModel = Vtiger_Module_Model::getInstance('SalesOrder');
		if(!empty($this->get('contact_id'))){
		...
		return "index.php?module=".$salesOrderModuleModel->getName()."&view=".$salesOrderModuleModel->getEditViewName()."&quote_id=".$this->getId()."&cf_1015=".$phone."&cf_1013=".$email;
	}
