...
include_once dirname(__FILE__). '/PayuMoneyPDFHeaderViewer.php';
class Vtiger_PayuMoneyPDFController extends Vtiger_InventoryPDFController{
	function buildHeaderModelTitle() {
		...
		return sprintf("%s: %s", $translatedSingularModuleLabel, $this->focusColumnValue('payumoney_no'));
	}

	function getHeaderViewer() {
		$headerViewer = new PayuMoneyPDFHeaderViewer();
