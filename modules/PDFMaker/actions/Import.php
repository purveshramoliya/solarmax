        ...
        if ($_FILES['import_file']['error'] == 0) {
            ...
            foreach ($xml->template as $data) {
                ...
                if ($PDFMaker->GetVersionType() == "professional" || in_array($tabid, $PDFMaker->GetBasicModules())) {
                    ...
                    $sql1 = "insert into vtiger_pdfmaker (filename,module,description,body,deleted,templateid,type) values (?,?,?,?,?,?,?)";
                    $params1 = array($filename, $modulename, $description, $body, 0, $templateid, $blocktype);
