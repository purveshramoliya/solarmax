...
class Leads_Record_Model extends Vtiger_Record_Model {
	...
	public function checkDuplicate($firstname,$lastname,$phone,$email) {
		$db = PearDatabase::getInstance();
		...
		$query = "SELECT 1 FROM  vtiger_leaddetails 
					...
					where ((firstname = ? and lastname = ?) or email = ? or vtiger_leadaddress.mobile = ?) and vtiger_crmentity.deleted = 0 ";
