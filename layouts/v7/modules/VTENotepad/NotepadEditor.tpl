...
{strip}
    <div class="pull-right commonActionsButtonContainer" style="margin: 10px">
        <div class="btn-group dropdown mega-dropdown">
            ...
            <ul class="dropdown-menu dropdownStyles commonActionsButtonDropDown mega-dropdown-menu" style="width: 400px">
                {*<li class="title">*}
                {*<input type="text">*}
                {*</li>*}
                ...
                <li id="vtiger_vtenotepad-container">
                    <div class="row-fluid">
                        <div class="span12">
                            <textarea name="" id="vtiger_vtenotepad-content" cols="30" rows="15" style="width: 100%"
