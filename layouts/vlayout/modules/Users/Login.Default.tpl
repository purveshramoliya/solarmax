...
<html>
	...
	<body>
		<div class="container-fluid login-container">
			<div class="row-fluid">
				<div class="span3">
					<div class="logo"><img height="60px" width="230px" src="layouts/vlayout/skins/images/logo.png">
					<br />
			...
			<!--<div class="span9">
					...
					</div> remoove from login page by purvesh ramoliya
				</div> -->
			</div>
			<div class="row-fluid" >
				<div class="span12">
							...
							<div class="row-fluid">
								<div class="span6" style="display:none;">
									<div class="carousal-container">
										<div><h2> Get more out of Tools </h2></div>
									<ul class="bxslider" >
											<li>
												<div id="slide01" class="slide">
													<img class="pull-left" src="{vimage_path('1.png')}">
<!-- 													<img class="pull-right" src="{vimage_path('android.png')}"/> by purvesh
 -->												</div>
											</li>
											<li>
												<div id="slide02" class="slide">
													<img class="pull-left" src="{vimage_path('2.png')}"/>
												<!-- 	<img class="pull-right" src="{vimage_path('iphone.png')}"/> by purvesh-->
												</div>
											</li>
											<li>
												<div id="slide03" class="slide">
													<img class="pull-left" src="{vimage_path('3.png')}"/>
													<!-- <img class="pull-right" src="{vimage_path('ipad.png')}"/>by purvesh -->
												</div>
											</li>
											<li>
												<div id="slide04" class="slide">
													<img class="pull-left" src="{vimage_path('4.png')}"/>
											<!-- 		<img class="pull-right" src="{vimage_path('exchange_conn.png')}"/>by purvesh -->
												</div>
											</li>
											<li>
												<div id="slide05" class="slide">
													<img class="pull-left" src="{vimage_path('5.png')}"/>
										<!-- 			<img class="pull-right" src="{vimage_path('outlook.png')}"/> by purvesh -->
											</li>
											<li>
												<div id="slide06" class="slide">
													<img class="pull-left" src="{vimage_path('6.png')}"/>
										<!-- 			<img class="pull-right" src="{vimage_path('outlook.png')}"/> by purvesh -->
											</li>
										</ul>
									</div>
			...
			<div class="control-group">
				...
				<div class="controls">
											...
											<div class="login-subscript" style="display:none;">
												<small> Powered by Biztechnosys </small> <!--if we want to add version behind compnay name than put {$CURRENT_VERSION} -->
											</div>
				</div>
				...
				<div class="container-fluid">
					<div class="row-fluid">
						<div class="span6 pull-left" >
							...
							<!-- <small>&#169 2016-{date('Y')}&nbsp; for a copyright start end year--> 
								<small>	<a href="http://www.Biztechnosys.com"> Biztechnosys.com</a> 
									<!--<a href="https://www.vtiger.com/LICENSE.txt">Read License</a> | 
									<a href="https://www.vtiger.com/products/crm/privacy_policy.html">Privacy Policy</a> </small> Display a link of read license and privacy_policy -->
							</div>
						</div>
						<div class="span6 pull-right" >
							<div class="pull-right footer-icons">
								<small>{vtranslate('LBL_CONNECT_WITH_US', $MODULE)}&nbsp;</small>
								<a href="https://www.facebook.com/biztechnosys/"><img src="layouts/vlayout/skins/images/facebook.png"></a>
								&nbsp;<a href="https://twitter.com/biztechnosys"><img src="layouts/vlayout/skins/images/twitter.png"></a>
								&nbsp;<a href="https://www.linkedin.com/company/2688727?trk=tyah&trkInfo=clickedVertical%3Acompany%2CclickedEntityId%3A2688727%2Cidx%3A2-1-2%2CtarId%3A1482926724878%2Ctas%3Abiztechno"><img src="layouts/vlayout/skins/images/linkedin.png"></a>
								&nbsp;<a href="https://www.youtube.com/channel/UC19-AJvuN1iJlxAdSCEzUSw"><img src="layouts/vlayout/skins/images/youtube.png"></a> 
							</div>
						</div>
					</div>   
				</div>    
