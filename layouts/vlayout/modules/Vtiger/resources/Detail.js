...
jQuery.Class("Vtiger_Detail_Js",{
	...
	saveFieldValues: function (fieldDetailList) {
		...
		if (fieldDetailList['field'] == "quotestage" && fieldDetailList['value'] == "Accepted") {
			let message = "Do you want to generate Invoice and Project";
			...
			Vtiger_Helper_Js.showConfirmationBox({ 'message': message }).then(
				function (e) {
					...
					data['action'] = 'GenerateInvoiceAndProject';
			...
			let message = "Do you want to generate Installer Project";
			Vtiger_Helper_Js.showConfirmationBox({ 'message': message }).then(
				function (e) {
					var module = app.getModuleName();
					var aDeferred1 = jQuery.Deferred();
					...
					data['record'] = recordId;
					data['module'] = app.getModuleName();
					data['action'] = 'GenerateInstallerProject';
					AppConnector.request(data).then(
						function (reponseData) {
							aDeferred1.resolve(reponseData);
						},
	...
	ajaxEditHandling : function(currentTdElement) {
			...
			if(fieldName  == 'bill_state' || fieldName  == 'bill_street' || fieldName  == 'bill_city' || fieldName  == 'bill_code' ){
