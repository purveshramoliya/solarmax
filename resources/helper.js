...
jQuery.Class("Vtiger_Helper_Js",{
	...
	heckDuplicateNameGeneralised : function(details) {
		...
		'lastname' :    document.getElementById("Leads_editView_fieldName_lastname").value,
		'phone' : document.getElementById("Leads_editView_fieldName_mobile").value,
		'email' :  document.getElementById("Leads_editView_fieldName_email").value,
		'record' : recordId
		}
		AppConnector.request(params).then(
			function(data) {
