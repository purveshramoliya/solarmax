...
function getConvertQuotesToInvoice($focus,$so_focus,$soid)
{
	global $log,$current_user;
	$log->debug("Entering getConvertSoToInvoice(".get_class($focus).",".get_class($so_focus).",".$soid.") method ...");
    $log->info("in getConvertSoToInvoice ".$soid);
    ...
    $focus->column_fields['currency_id'] = $so_focus->column_fields['currency_id'];
    $focus->column_fields['conversion_rate'] = $so_focus->column_fields['conversion_rate'];
	$focus->column_fields['cf_753'] = $so_focus->column_fields['cf_753'];
	$focus->column_fields['cf_755'] = $so_focus->column_fields['cf_755'];
	$focus->column_fields['cf_757'] = $so_focus->column_fields['cf_757'];
	$focus->column_fields['cf_759'] = $so_focus->column_fields['cf_759'];
	$focus->column_fields['cf_761'] = $so_focus->column_fields['cf_761'];
	$focus->column_fields['cf_763'] = $so_focus->column_fields['cf_763'];
	$focus->column_fields['cf_765'] = $so_focus->column_fields['cf_765'];
	$focus->column_fields['cf_767'] = $so_focus->column_fields['cf_767'];
	$focus->column_fields['cf_769'] = $so_focus->column_fields['cf_769'];
	$focus->column_fields['cf_771'] = $so_focus->column_fields['cf_771'];
	$focus->column_fields['cf_773'] = $so_focus->column_fields['cf_773'];
	$focus->column_fields['cf_775'] = $so_focus->column_fields['cf_775'];
	$log->debug("Exiting getConvertSoToInvoice method ...");
	return $focus;

}

function getConvertSalesOrderToInvoice($focus,$so_focus,$soid)
{
	global $log,$current_user;
	$log->debug("Entering getConvertSoToInvoice(".get_class($focus).",".get_class($so_focus).",".$soid.") method ...");
    $log->info("in getConvertSoToInvoice ".$soid);
...
function getAssociatedProducts($module,$focus,$seid='')
{
	...
	if($module == 'Quotes' || $module == 'PurchaseOrder' || $module == 'SalesOrder' || $module == 'Invoice' || $module == 'PayuMoney' || $module == 'Custpurchase')
	{
		$query="SELECT
	...
	for($i=1;$i<=$num_rows;$i++)
	{
		...
		$paymentno=$adb->query_result($result,$i-1,'paymentno');
        ...
        $product_Detail[$i]['paymentno'.$i]=$paymentno;
		...
		if($module == 'PurchaseOrder' || $module == 'SalesOrder' || $module == 'Quotes' || $module == 'Invoice'  || $module == 'PayuMoney' || $module == 'Custpurchase')
		{
