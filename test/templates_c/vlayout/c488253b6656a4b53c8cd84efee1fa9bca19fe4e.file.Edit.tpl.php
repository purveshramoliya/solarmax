<?php /* Smarty version Smarty-3.1.7, created on 2021-09-15 14:10:37
         compiled from "/home/customer/www/solarmaxx.magento2solution.com/public_html/includes/runtime/../../layouts/vlayout/modules/PDFMaker/Edit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15398883546126145976d396-20076286%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c488253b6656a4b53c8cd84efee1fa9bca19fe4e' => 
    array (
      0 => '/home/customer/www/solarmaxx.magento2solution.com/public_html/includes/runtime/../../layouts/vlayout/modules/PDFMaker/Edit.tpl',
      1 => 1631714818,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15398883546126145976d396-20076286',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_61261459a8b7f',
  'variables' => 
  array (
    'PARENTTAB' => 0,
    'SAVETEMPLATEID' => 0,
...
<?php if ($_valid && !is_callable('content_61261459a8b7f')) {function content_61261459a8b7f($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/customer/www/solarmaxx.magento2solution.com/public_html/libraries/Smarty/libs/plugins/function.html_options.php';
?>
                                    ...
                                    <td class="fieldValue" colspan="3">
                                        ...
                                        <div class="row-fluid ">
                                            ...
                                            <div class="btn-group span2">
                                                <button type="button" class="btn btn-success marginLeftZero InsertIntoTemplate" data-type="modulefields"  title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
"><bold>$</bold></button>
...
"><?php echo $_smarty_tpl->tpl_vars['RelMod']->value[1];?>
 (<?php echo $_smarty_tpl->tpl_vars['RelMod']->value[2];?>
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <div class="btn-group span2">
                                                <button type="button" class="btn btn-success InsertIntoTemplate marginLeftZero" data-type="relatedmodulefields" title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
"><bold>$</bold></button><button type="button" class="btn btn-warning InsertLIntoTemplate" data-type="relatedmodulefields" title="<?php echo vtranslate('LBL_INSERT_LABEL_TO_TEXT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"><bold>T</bold></button>
                                            </div>
                                        </div>
                                    </td>
...
:</label></td>
                                        <td class="fieldValue" colspan="3">
                                            ...
                                            <button type="button" class="btn btn-success InsertIntoTemplate marginLeftZero" data-type="header_var" title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
"><bold>$</bold></button>
...
:</label></td>
                                    <td class="fieldValue row-fluid" colspan="3">
                                        ...
                                        <div class="btn-group span2">
                                            <button type="button" class="btn btn-success InsertIntoTemplate marginLeftZero" data-type="acc_info" title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
"><bold>$</bold></button>
...
:</label></td>
                                    <td class="fieldValue" colspan="3">
                                        ...
                                        <div id="user_info_div" class="au_info_div row-fluid" style="display:inline;">
                                            ...
                                            <div class="btn-group span2">
                                                <button type="button" class="btn btn-success InsertIntoTemplate marginLeftZero" data-type="user_info" title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
"><bold>$</bold></button>
...
"><bold>T</bold></button>
                                        ...
                                        <div id="logged_user_info_div" class="au_info_div row-fluid" style="display:none;">
                                            ...
                                            <div class="btn-group span2">
                                                <button type="button" class="btn btn-success marginLeftZero InsertIntoTemplate" data-type="logged_user_info" title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
"><bold>$</bold></button>
...
"><bold>T</bold></button>
                                        ...
                                        <div id="modifiedby_user_info_div" class="au_info_div row-fluid" style="display:none;">
                                            ...
                                            <div class="btn-group span2">
                                                <button type="button" class="btn btn-success InsertIntoTemplate marginLeftZero" data-type="modifiedby_user_info" title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
"><bold>$</bold></button>
...
"><bold>T</bold></button>
                                        ...
                                        <div id="smcreator_user_info_div" class="au_info_div row-fluid hide">
                                            ...
                                            <div class="btn-group span2">
                                                <button type="button" class="btn btn-success InsertIntoTemplate marginLeftZero"  data-type="smcreator_user_info" title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
"><bold>$</bold></button>
...
:</label></td>
                                    <td class="fieldValue row-fluid" colspan="3">
                                        ...
                                        <div class="btn-group span1">
                                            <button type="button" class="btn btn-warning InsertIntoTemplate marginLeftZero" data-type="global_lang" title="<?php echo vtranslate('LBL_INSERT_LABEL_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_LABEL_TO_TEXT','PDFMaker');?>
"><bold>T</bold></button>
                                        </div>
                                    </td>
                                </tr>
...
:</label></td>
                                    <td class="fieldValue row-fluid" colspan="3">
                                        ...
                                        <div class="btn-group span1">
                                        <button type="button" class="btn btn-warning InsertIntoTemplate marginLeftZero" data-type="module_lang" title="<?php echo vtranslate('LBL_INSERT_LABEL_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_LABEL_TO_TEXT','PDFMaker');?>
"><bold>T</bold></button>
                                        </div>
                                    </td>
...
:</label></td>
                                        <td class="fieldValue row-fluid" colspan="3">
                                            ...
                                            <div class="btn-group span1">
                                                <button type="button" class="btn btn-warning marginLeftZero InsertIntoTemplate" data-type="custom_lang" title="<?php echo vtranslate('LBL_INSERT_LABEL_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_LABEL_TO_TEXT','PDFMaker');?>
"><bold>T</bold></button>
                                            </div>
                                        </td>
...
:</label></td>
                                        <td class="fieldValue row-fluid" colspan="3">
                                            ...
                                            <div class="btn-group span1">
                                                <button type="button" class="btn btn-success InsertIntoTemplate marginLeftZero" data-type="multicomapny" title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
"><bold>$</bold></button>
                                            </div>
                                        </td>
...
:</label></td>
                                    <td class="fieldValue row-fluid" colspan="3">
                                        ...
                                        <div class="btn-group span1">
                                            <button type="button" class="btn btn-success InsertIntoTemplate marginLeftZero" data-type="invterandcon" title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
"><bold>$</bold></button>
                                        </div>
                                    </td>
...
:</label></td>
                                    <td class="fieldValue row-fluid" colspan="3">
                                        ...
                                        <div class="btn-group span1">
                                            <button type="button" class="btn btn-success InsertIntoTemplate marginLeftZero" data-type="dateval" title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
"><bold>$</bold></button>
                                        </div>
                                    </td>
...
"><bold>$</bold></button>
                                ...
                                <?php }?>
                                <tr>
                                    <td class="fieldLabel"><label class="muted pull-right marginRight10px"><?php echo vtranslate('LBL_FONT_AWESOME',$_smarty_tpl->tpl_vars['MODULE']->value);?>
:</label></td>
                                    <td class="fieldValue row-fluid" colspan="3">
                                        <div class="span10">
                                            <select name="fontawesomeicons" id="fontawesomeicons" class="chzn-select row-fluid">
                                                <?php  $_smarty_tpl->tpl_vars['FONTAWESOMEDATA'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['FONTAWESOMEDATA']->_loop = false;
...
?>
                                                    <?php if ($_smarty_tpl->tpl_vars['SELECTEDFONTAWESOMEICON']->value==''){?><?php $_smarty_tpl->tpl_vars['SELECTEDFONTAWESOMEICON'] = new Smarty_variable($_smarty_tpl->tpl_vars['FONTAWESOMEDATA']->value['name'], null, 0);?><?php }?>
...
"><span id="fontawesomepreview" class="fapreview"></span></button>&nbsp;&nbsp;<a href="index.php?module=PDFMaker&view=IndexAjax&mode=getAwesomeInfoPDF" target="_new"><button type="button" class="btn"><i class="icon-info-sign"></i></button></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php if (vtlib_isModuleActive('ITS4YouSignature')){?>
                                <tr>
                                    <td class="fieldLabel">
                                        <label class="muted pull-right marginRight10px">
                                            <?php echo vtranslate('LBL_IS_SIGNATURE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
:
                                        </label>
                                    </td>
                                    <td class="fieldValue row-fluid" colspan="3">
                                        <div class="span10">
                                            <select name="signaturevalues" id="signaturevalues" class="chzn-select row-fluid">
                                                <option value="PDF_SIGNATURE"><?php echo vtranslate('PDF_SIGNATURE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</option>
                                            </select>
                                        </div>
                                        <div class="btn-group span2">
                                            <button type="button" class="btn btn-success InsertIntoTemplate marginLeftZero" data-type="signaturevalues" title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
">
                                                <bold>$</bold>
                                            </button>
...
:</label></td>
                                    <td class="fieldValue" colspan="3">
                                        ...
                                        <button type="button" class="btn btn-success marginLeftZero InsertIntoTemplate" data-type="header_var" title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
"><bold>$</bold></button>
                                    </td>
                                </tr>
...
:</label></td>
                                    <td class="fieldValue row-fluid" colspan="3">
                                        ...
                                        <div class="span1">
                                            <button type="button" class="btn btn-success InsertIntoTemplate marginLeftZero" data-type="psfields" title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
"><bold>$</bold></button>
                                        </div>
                                    </td>
...
:</label></td>
                                    <td class="fieldValue row-fluid" colspan="3">
                                        ...
                                        <div class="span1">
                                            <button type="button" class="btn btn-success InsertIntoTemplate marginLeftZero" data-type="productfields" title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
"><bold>$</bold></button>
                                        </div>
                                    </td>
...
:</label></td>
                                    <td class="fieldValue row-fluid" colspan="3">
                                        ...
                                        <div class="span1">
                                            <button type="button" class="btn btn-success InsertIntoTemplate marginLeftZero" data-type="servicesfields" title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
" alt="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT','PDFMaker');?>
"><bold>$</bold></button>
                                        </div>
                                    </td>
...
"/></td>
                                ...
                                <tr>
                                    <td class="fieldLabel"><label class="muted pull-right marginRight10px"><?php echo vtranslate('LBL_DEFAULT_PRODUCT_IMAGE','PDFMaker');?>
:</label></td>
                                    <td class="fieldValue" colspan="3">
                                        <table>
                                            <tr>
                                                <td align="right" nowrap><?php echo vtranslate('LBL_WIDTH_PX','PDFMaker');?>
</td>
                                                <td><input type="text" maxlength="3" name="product_image_width" class="detailedViewTextBox" value="<?php echo $_smarty_tpl->tpl_vars['PDF_TEMPLATE_RESULT']->value['product_image_width'];?>
" style="width:<?php echo $_smarty_tpl->tpl_vars['margin_input_width']->value;?>
"/></td>
                                            </tr>
                                            <tr>
                                                <td align="right" nowrap><?php echo vtranslate('LBL_HEIGHT_PX','PDFMaker');?>
</td>
                                                <td><input type="text" maxlength="3" name="product_image_height" class="detailedViewTextBox" value="<?php echo $_smarty_tpl->tpl_vars['PDF_TEMPLATE_RESULT']->value['product_image_height'];?>
" style="width:<?php echo $_smarty_tpl->tpl_vars['margin_input_width']->value;?>
"/></td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td class="fieldLabel">
                                        <label class="muted pull-right marginRight10px">
                                            <?php echo vtranslate('LBL_SIGNATURE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
:
                                        </label>
                                    </td>
                                    <td>
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="inputElement" name="signature_width" value="<?php echo $_smarty_tpl->tpl_vars['SIGNATURE_WIDTH']->value;?>
">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="inputElement" name="signature_height" value="<?php echo $_smarty_tpl->tpl_vars['SIGNATURE_HEIGHT']->value;?>
">
                                                </td>
                                            </tr>
                                        </table>
...
" style="border: 1px solid black; " class="CodeMirror" tabindex="5"><?php echo $_smarty_tpl->tpl_vars['STYLE_DATA']->value['stylecontent'];?>
                    ...
                    <?php }?>
                    <div class="hide"><textarea id="fontawesomeclass"><?php echo $_smarty_tpl->tpl_vars['FONTAWESOMECLASS']->value;?>
</textarea></div>
...
:</div>
                ...
                <div span="span1">
                    <button type="button" class="btn btn-success InsertIntoTextarea" data-type="filename_fields2" title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"><bold>$</bold></button>
                </div>
            </div>
            <br>
...
:</div>
            ...
            <div class="row-fluid">
                ...
                <div span="span1">
                    <button type="button" class="btn btn-success InsertIntoTextarea" data-type="relatedmodulefields2" title="<?php echo vtranslate('LBL_INSERT_VARIABLE_TO_TEXT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"><bold>$</bold></button>
                </div>
            </div>
            <br>
