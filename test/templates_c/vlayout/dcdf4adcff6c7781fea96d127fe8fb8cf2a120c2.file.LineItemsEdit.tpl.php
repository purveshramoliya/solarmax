<?php /* Smarty version Smarty-3.1.7, created on 2021-08-14 08:20:35
         compiled from "/home/customer/www/solarmaxx.magento2solution.com/public_html/includes/runtime/../../layouts/vlayout/modules/Inventory/LineItemsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:24816907461177cd3e52b46-83968366%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dcdf4adcff6c7781fea96d127fe8fb8cf2a120c2' => 
    array (
      0 => '/home/customer/www/solarmaxx.magento2solution.com/public_html/includes/runtime/../../layouts/vlayout/modules/Inventory/LineItemsEdit.tpl',
      1 => 1628927583,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '24816907461177cd3e52b46-83968366',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61177cd405336',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61177cd405336')) {function content_61177cd405336($_smarty_tpl) {?>
...
" /><table class="table table-bordered blockContainer lineItemTable" id="lineItemTab"><?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='PayuMoney'){?><tr><th colspan="2"><span class="inventoryLineItemHeader"><?php echo vtranslate('LBL_ITEM_DETAILS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</OPTION></select></div></th></tr><?php }?><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='PayuMoney'){?><tr><th colspan="7">Payment Details</th></tr><?php }?><tr><td><b><?php echo vtranslate('LBL_TOOLS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</b></td><?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='PayuMoney'){?><td><span class="redColor">*</span><b><?php echo vtranslate('LBL_ITEM_NAME',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</b></td><?php }?><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='PayuMoney'){?><td><b>Payment Type </b></td><td><b>Payment no</b></td><td><b>Bank Name</b></td><td><b>Payment Date</b></td><td><b>Payment Total</b></td><td><b>Total</b></td><?php }?></tr><tr id="row0" class="hide lineItemCloneCopy"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("LineItemsContent.tpl",'Inventory'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('row_no'=>0,'data'=>array()), 0);?>
...
</strong></button></span></div><?php }elseif($_smarty_tpl->tpl_vars['PRODUCT_ACTIVE']->value=='true'){?><div class="btn-group"><?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='PayuMoney'){?><button type="button" class="btn addButton" id="addProduct"><i class="icon-plus"></i><strong> <?php echo vtranslate('LBL_ADD_PRODUCT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button><?php }?><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='PayuMoney'){?><button type="button" class="btn addButton" id="addProduct"><i class="icon-plus"></i><strong>Add Payment</strong></strong></button><?php }?></div><?php }elseif($_smarty_tpl->tpl_vars['SERVICE_ACTIVE']->value=='true'){?><div class="btn-group"><button type="button" class="btn addButton" id="addService"><i class="icon-plus icon-white"></i><strong> <?php echo vtranslate('LBL_ADD_SERVICE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button></div><?php }?></div></div><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='PayuMoney'){?><table class="table table-bordered blockContainer lineItemTable" id="lineItemResult"><tr><td  width="83%"><div class="pull-right"><strong>Total</strong></div></td><td><div id="netTotal" class="pull-right netTotal"><?php if (!empty($_smarty_tpl->tpl_vars['FINAL']->value['hdnSubTotal'])){?><?php echo $_smarty_tpl->tpl_vars['FINAL']->value['hdnSubTotal'];?>
<?php }else{ ?>0<?php }?></div></td></tr></table><?php }?><?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='PayuMoney'){?><table class="table table-bordered blockContainer lineItemTable" id="lineItemResult"><tr><td  width="83%"><div class="pull-right"><strong><?php echo vtranslate('LBL_ITEMS_TOTAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?>" readonly></span></td></tr><?php }?></table><?php }?><br><input type="hidden" name="totalProductCount" id="totalProductCount" value="<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
