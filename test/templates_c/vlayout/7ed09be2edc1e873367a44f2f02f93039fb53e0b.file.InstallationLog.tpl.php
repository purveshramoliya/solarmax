<?php /* Smarty version Smarty-3.1.7, created on 2021-09-28 18:48:29
         compiled from "/home/customer/www/solarmaxx.magento2solution.com/public_html/includes/runtime/../../layouts/vlayout/modules/Settings/ITS4YouInstaller/InstallationLog.tpl" */ ?>
<?php /*%%SmartyHeaderCode:270278176141fe01f26c89-11249838%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7ed09be2edc1e873367a44f2f02f93039fb53e0b' => 
    array (
      0 => '/home/customer/www/solarmaxx.magento2solution.com/public_html/includes/runtime/../../layouts/vlayout/modules/Settings/ITS4YouInstaller/InstallationLog.tpl',
      1 => 1631714980,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '270278176141fe01f26c89-11249838',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_6141fe0208410',
  'variables' => 
  array (
    'ERROR' => 0,
    'MODULE_ACTION' => 0,
...
<?php if ($_valid && !is_callable('content_6141fe0208410')) {function content_6141fe0208410($_smarty_tpl) {?>
<div class="modal-dialog modal-lg installationLog" style="background: #fff;"><div class='modal-content'><div class="modal-header"><div class="pull-right" ><button type="button" class="close" aria-label="Close" data-dismiss="modal"><span aria-hidden="true" class='fa fa-close'>X</span></button></div><div><div class="col-lg-11 col-md-11"><?php if ($_smarty_tpl->tpl_vars['ERROR']->value){?><input type="hidden" name="installationStatus" value="error" /><h3 class="modal-title" style="color: red"><?php if ($_smarty_tpl->tpl_vars['MODULE_ACTION']->value=="Upgrade"){?><?php echo vtranslate('LBL_UPGRADE_FAILED',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
<?php }?></h3><?php }?></div></div></div><div class="modal-body" id="installationLog" style="width: 600px; height: 400px; overflow: auto;"><h3><?php if ($_smarty_tpl->tpl_vars['MODULE_ACTION']->value=="Upgrade"){?><?php echo vtranslate('LBL_UPGRADE_LOG',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
